...
{
    public partial class fr_BC_Quy : Form
    {
        public fr_BC_Quy()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            sql = @"SELECT     tongtien, IdCustomer FROM db_SB WHERE DateSale BETWEEN '" + d1.Text + "' AND '" + d2.Text + "'";
            ...
            exRange.Range["B11:B11"].Value = "ID Customer";
        ...
        private void fr_BC_Quy_Load(object sender, EventArgs e)
        {
