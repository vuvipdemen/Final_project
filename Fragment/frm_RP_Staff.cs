...
namespace StoreManager.Presentation
{
    public partial class fr_BC_NV : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["C2:E2"].Value = "REPORT";
            //Lấy thông tin các mặt hàng
            sql = @"SELECT db_SB.IdStaff, sum(db_rp_SB.Quantity) AS T FROM db_SB INNER JOIN db_rp_SB ON db_SB.IdSB = db_rp_SB.IdSB where db_SB.IdStaff='"+cbnv.Text+"' group by db_SB.IdStaff order by sum(db_rp_SB.Quantity) ASC";
            ...
            exRange.Range["B11:B11"].Value = "ID Staff";
